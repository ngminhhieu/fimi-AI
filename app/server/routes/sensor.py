...
@router.post("/calibrate_by_id/{device_id}", response_description="update device")
async def calibrate_one_device(device_id):
    ...
    return ResponseModel(updated_sensors, "sensor updated successfully.") 


@router.post("/calibrate_all_devices", response_description="update device")
